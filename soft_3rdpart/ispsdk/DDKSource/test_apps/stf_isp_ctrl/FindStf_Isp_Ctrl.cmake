...
set (STF_ISP_CTRL_FOUND TRUE)

set (STF_ISP_CTRL_INCLUDE_DIRS 
    ${STFDRVAPI_INCLUDE_DIRS}
    ${ISPC_INCLUDE_DIRS}
    ${SENSORAPI_INCLUDE_DIRS}
    ${STF_ISP_CTRL_PREFIX}/include
)

set (STF_ISP_CTRL_DEFINITIONS 
    ${STFDRVAPI_DEFINITIONS}
    ${ISPC_DEFINITIONS}
    ${SENSORAPI_DEFINITIONS}
)
set (STF_ISP_CTRL_DOXYGEN_SRC ${STF_ISP_CTRL}/src)
set (STF_ISP_CTRL_LIBRARIES STF_ISP_CTRL)
